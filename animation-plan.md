...
If the old or new position is non-existing (new or disappearing key), assume this position to be outside the SVG boundary on a line from the keyboard center and through the key's existing position.
...
TODO list:
 ...
 - [x] adapt the RowBasedKeyboard component to accept a list of key movements and forward each element to the Key component.
