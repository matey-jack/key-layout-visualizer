...
| 8 | **Pre-render / SSG** - Use a prerendering plugin to generate static HTML with actual content for crawlers | 5 | 4 | not needed, since #3 is already adding all important text from the app. |
