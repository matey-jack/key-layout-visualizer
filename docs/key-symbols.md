...
Whenever this document and those three tables disagree, they are right and this document needs fixing.
...
Rejected: ⎋ (U+238B broken circle with northwest arrow). It is the correct Unicode escape-key symbol, and we
decided against it anyway: almost nobody recognises it, and at key-cap size the broken circle turns to mush.
Three letters are clearer than a glyph that has to be explained.
...
| ⎋ | U+238B | Escape, if we ever decide the symbol is worth it after all. |
