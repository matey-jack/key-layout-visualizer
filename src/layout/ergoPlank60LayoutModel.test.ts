...
import {ep60WithArrowsLayoutModel, ergoPlank60AnsiAngleLayoutModel} from "./ergoPlank60LayoutModel.ts";
...
describe('ergoPlank60LayoutModel', () => {
    it('has a gap in the merged mapping', () => {
        const charMap = fillMapping(ergoPlank60AnsiAngleLayoutModel, qwertyMapping)!;
        expect(charMap[1]).toEqual(['↹', 'q', 'w', 'e', 'r', 't', '-', null,  '=', 'y', 'u', 'i', 'o', 'p', '\\']);
        const keyPositions = getKeyPositions(ergoPlank60AnsiAngleLayoutModel, false, charMap);
