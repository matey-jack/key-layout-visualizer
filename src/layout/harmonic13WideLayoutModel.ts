import {FlexMapping, harmonicStaggerOffsets, KeyboardRows, KeymapTypeId, type LayoutMapping, type RowBasedLayoutModel, SupportedKeymapType} from "../base-model.ts";
