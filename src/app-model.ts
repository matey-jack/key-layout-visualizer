...
export enum EB65_MidShift_Variant {
    ...
    MIDDLE_WIDE, // Same key sizes as low shift wide hands; even same hand position; only Shift assignment moves. (This is the widest possible hand position that still fits the traditional Return key position.
